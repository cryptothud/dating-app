...
const ANCHORS: [number, number, number][] = [
  ...
  [40.7282, -73.8530, 5],  // Forest Hills / Rego Park
  // Bronx
  [40.8448, -73.8648, 7],  // South Bronx / Mott Haven
  // Phoenix
  [33.4484, -112.0740, 14], // Downtown Phoenix
  [33.4734, -112.0740, 9],  // Midtown Phoenix
  [33.4534, -112.0686, 8],  // Roosevelt Row / Arts District
  [33.5093, -112.0259, 7],  // Uptown / Camelback Corridor
  [33.4255, -111.9400, 8],  // Tempe / ASU
...
const NAMES = [
  ...
  'Avery', 'Blake', 'Drew', 'Reese', 'Skyler', 'Cameron', 'Logan', 'Peyton',
  'Dylan', 'Harper', 'Emery', 'Finley', 'Sage', 'River', 'Phoenix', 'Rowan',
  'Marcus', 'Dante', 'Isaiah', 'Andre', 'Malik', 'Jaden', 'Chris', 'Mike',
  'Nadia', 'Sofia', 'Priya', 'Elena', 'Maya', 'Leila', 'Zara', 'Amara',
  'Ethan', 'Liam', 'Noah', 'Owen', 'Caleb', 'Miles', 'Kai', 'Jin',
  'Luna', 'Jade', 'Iris', 'Vera', 'Simone', 'Naomi', 'Keisha', 'Fatima',
  'Sebastian', 'Adrian', 'Julian', 'Rafael', 'Carlos', 'Diego', 'Marco', 'Leo',
  'Jess', 'Sam', 'Ash', 'Nico', 'Eli', 'Remi', 'Sasha', 'Charlie',
  'Whitney', 'Brianna', 'Talia', 'Camille', 'Yuki', 'Hana', 'Mia', 'Zoe',
  'Tyler', 'Brandon', 'Devon', 'Hayden', 'Kendall', 'Paige', 'Brooke', 'Lacey',
  'Ren', 'Kai', 'Soren', 'Piper', 'Wren', 'Shiloh', 'Bellamy', 'Harlow',
]

const BODY_TYPES = ['slim', 'athletic', 'average', 'muscular', 'curvy', 'average', 'athletic', 'slim']
...
async function main(): Promise<void> {
  ...
  for (let i = 0; i < toCreate; i++) {
    ...
    const lastActiveOffset =
      r < 0.60 ? Math.random() * 24 * 3600_000
      : r < 0.90 ? Math.random() * 7 * 24 * 3600_000
