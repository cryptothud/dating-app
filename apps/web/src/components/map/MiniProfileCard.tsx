  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="bg-background/95 border-border absolute bottom-4 left-4 right-4 z-50 overflow-hidden rounded-2xl border shadow-2xl backdrop-blur-xl"
      ...
      >
        <div className="flex gap-4 p-4">
          <div className="bg-muted relative h-20 w-20 flex-shrink-0 overflow-hidden rounded-xl">
            ...
            {user.isVerified && (
              <span className="bg-primary absolute bottom-1 right-1 flex h-4 w-4 items-center justify-center rounded-full">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className={`mt-0.5 text-xs ${statusColor}`}>{statusLabel}</p>
          </div>
          ...
          <div className="flex items-center gap-1">
            {isAuthenticated && (
              <button
                ...
                className="bg-muted text-muted-foreground hover:text-foreground flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-full transition-colors"
        ...
        <div className="px-4 pb-4">
          {isAuthenticated ? (
            <button onClick={() => onMessage(user.id)} className="btn-primary w-full">
              Message
            </button>
          ) : (
