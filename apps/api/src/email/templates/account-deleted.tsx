...
export function AccountDeletedEmail({ recoveryDeadline }: Props) {
  return (
    <Layout preview="Your CRUSH account has been deleted">
      ...
      <Text style={body}>
        Your CRUSH account and all associated data have been queued for deletion. This process
        completes within 30 days.
      </Text>
      <Text style={recoveryNote}>
        Changed your mind? You can recover your account by signing in before{' '}
        <strong>{recoveryDeadline}</strong>. After that date, your data is permanently removed and
        cannot be recovered.
      </Text>
      <Text style={body}>
