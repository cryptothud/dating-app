...
export function WelcomeEmail({ displayName, mapUrl }: Props) {
  ...
  return (
    <Layout preview="Welcome to CRUSH — you're in.">
      ...
      <Text style={body}>
        Your account is live. Complete your profile so people nearby can find you on the map — add a photo, a few details about yourself, and flip on "Looking?" when you want to meet up.
      </Text>
      <Button href={mapUrl} style={btn}>Open the map</Button>
      <Text style={hint}>
        Have questions? Reply to this email or visit{' '}
        <Link href={mapUrl} style={{ color: PURPLE }}>crush.app</Link>.
      </Text>
    </Layout>
  )
}
