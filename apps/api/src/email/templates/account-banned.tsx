...
const reasonBox = { backgroundColor: '#0f0b1a', borderRadius: '10px', padding: '16px 20px', margin: '0 0 20px' }
const reasonText = { color: TEXT, fontSize: '14px', lineHeight: '22px', margin: 0, fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif' }
...
export function AccountBannedEmail({ reason }: Props) {
  return (
    <Layout preview="Your CRUSH account has been permanently banned">
      ...
      <Text style={body}>
        Your CRUSH account has been permanently banned for a severe violation of our Terms of Service:
      </Text>
      <div style={reasonBox}>
        <Text style={reasonText}>{reason}</Text>
      </div>
      <Text style={body}>
        This decision is final. Creating new accounts to circumvent this ban is a further violation of our Terms and may result in additional action.
      </Text>
    </Layout>
  )
}
