...
export function PasswordResetEmail({ resetUrl }: Props) {
  return (
    <Layout preview="Reset your CRUSH password — link expires in 15 minutes">
      ...
      <Text style={body}>
        We received a request to reset your CRUSH password. Click the button below to set a new one. This link expires in <strong style={{ color: TEXT }}>15 minutes</strong>.
      </Text>
      <Button href={resetUrl} style={btn}>Reset password</Button>
      <Text style={hint}>
