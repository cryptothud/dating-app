import { IsString, IsOptional, IsBoolean, MinLength, MaxLength, IsInt, Min, Max, IsIn, IsUrl, IsPositive } from 'class-validator'
...
export class TimeoutDto {
  @IsInt() @IsPositive() @Max(43200) // max 30 days in minutes
